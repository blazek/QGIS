...
void QgsGml::setAttributes( const QgsFieldMap & fieldMap )
{
...
void QgsGml::setFeatureType( const QString & typeName, const QString& geometryAttribute, const QgsFieldMap & fieldMap )
{
  mTypeName = typeName;
  mGeometryAttribute = geometryAttribute;
