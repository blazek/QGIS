...
QgsIdentifyResultsFeatureItem::QgsIdentifyResultsFeatureItem( const QgsFieldMap &fields, const QgsFeature &feature, const QgsCoordinateReferenceSystem &crs, const QStringList & strings )
...
void QgsIdentifyResults::on_mCopyToolButton_clicked( bool checked )
{
  Q_UNUSED( checked );
  QgsDebugMsg( "Entered" );
...
void QgsIdentifyResults::formatChanged( int index )
{
  QgsDebugMsg( "Entered" );
